...
public final class StorageHelper {
	 ...
	 * 获取当前app文件存储路径
	 * 
	 * @return 返回File对象实例，表示当前app文件存储根目�?
	 */
	 ...
	 * 获取当前app存放图片文件的目�?
	 * 
	 * @return 返回File对象实例，表示当前app存储图片的目�?
	 */
